...
urlpatterns=[
    ...
    path('ksp6week/intro6wk/', views.intro6wk, name='intro6wk'),
    path('ksp6week/kspchallenge/', views.kspchallenge, name='kspchallenge'),
    ...
    path('ksp6week/monday/', views.monday, name='monday'),
    path('ksp6week/tuesday/', views.tuesday, name='tuesday'),
    path('ksp6week/wednesday/', views.wednesday, name='wednesday'),
    path('ksp6week/thursday/', views.thursday, name='thursday'),
    path('ksp6week/friday/', views.friday, name='friday'),
